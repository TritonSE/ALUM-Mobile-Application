...
const IMAGE_NOT_SAVED = "Image was not able to be saved. Be sure to specify that image key is image";
...
export class ServiceError extends CustomError {
    ...
    static IMAGE_WAS_NOT_FOUND = new ServiceError(5, 402, IMAGE_NOT_FOUND);
}