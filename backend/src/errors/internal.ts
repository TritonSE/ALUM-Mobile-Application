...
const ERROR_ROLES_NOT_MENTOR_MENTEE_NOT_IMPLEMENTED = "Any roles other than mentor/mentee has not been implemented."
export class InternalError extends CustomError {
  ...
  static ERROR_ROLES_NOT_MENTOR_MENTEE_NOT_IMPLEMENTED = new InternalError(8, 500, ERROR_ROLES_NOT_MENTOR_MENTEE_NOT_IMPLEMENTED);
}
